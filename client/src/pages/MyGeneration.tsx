...
// Maps the ratio strings from assets.ts to actual Tailwind aspect-ratio classes
...
const MyGeneration = () => {
    ...
    const handleDownload = (thumb: IThumbnail) => {
        if (thumb.image_url) {
                        ...
                        {thumbnails.map((thumb: IThumbnail) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="mb-8 group relative cursor-pointer rounded-2xl break-inside-avoid"
                                >
                                    {/* IMAGE */}
