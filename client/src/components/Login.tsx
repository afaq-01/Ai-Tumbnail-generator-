    ...
    <>
        ...
        <div className="min-h-screen flex items-center justify-center">
            <form
                ...
                {state !== "login" && (
                    <div className="flex items-center mt-6 w-full bg-white/5 ring-2 ring-white/10 focus-within:ring-pink-500 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <div className="flex items-center w-full mt-4 bg-white/5 ring-2 ring-white/10 focus-within:ring-pink-500 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <div className=" flex items-center mt-4 w-full bg-white/5 ring-2 ring-white/10 focus-within:pink-500 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <button type="submit" className="mt-2 w-full h-11 rounded-full text-white bg-pink-500 hover:bg-pink-500-500 transition " >
                    {state === "login" ? "Login" : "Sign up"}
                </button>

                <p onClick={() => setState(prev => prev === "login" ? "register" : "login")} className="text-gray-400 text-sm mt-3 mb-11 cursor-pointer" >
                    {state === "login" ? "Don't have an account?" : "Already have an account?"}
                    <span className="text-pink-500 hover:underline ml-1">click here</span>
                </p>
            </form>
